	...
	<div class="col-md-6 ui-sortable">
		<div class="panel panel-inverse" data-sortable-id="form-stuff-1"  data-init="true">
			...
			<div class="panel-heading ui-sortable-handle">
				<h4 class="panel-title">KELOLA DATA ABOUT</h4>
					...
					<thead>
						<table id="data-table-default" class="table  table-bordered table-hover table-td-valign-middle">
							...
							<tr>
								...
								<td> <textarea class="form-control" rows="8" name="description" id="description" placeholder="Description"><?php echo $description; ?></textarea></td>
							</tr>
							...
							<?php } else { ?>
								<div class="form-group">
									<tr>
										<td>Photo <?php echo form_error('photo') ?></td>
										<td>
											<a href="#modal-dialog" data-bs-toggle="modal"><img src="<?php echo base_url(); ?>assets/web/img/about/<?= $photo ?>" style="width: 150px;height: 150px;border-radius: 5%;"></img></a>
							...
							<tr>
								<td></td>
								<td><input type="hidden" name="about_id" value="<?php echo $about_id; ?>" />
