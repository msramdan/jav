								...
								<td>
                                 ...
                                 ";
										...
										<?php foreach ($subMenu as $sm) :
											...
											<?php } else { ?>
												<input class="form-check-input create-access" type="checkbox" <?= check_access_create($role['level_id'], $sm['sub_menu_id']); ?> data-level="<?= $role['level_id']; ?>" data-submenu="<?= $sm['sub_menu_id'] ?>">
											<?php } ?>
								...
								<td>
                                 ...
                                 ";
										...
										<?php foreach ($subMenu as $sm) :
											...
											<?php } else { ?>
												<input class="form-check-input update-access" type="checkbox" <?= check_access_update($role['level_id'], $sm['sub_menu_id']); ?> data-level="<?= $role['level_id']; ?>" data-submenu="<?= $sm['sub_menu_id'] ?>">
											<?php } ?>
											<label style="margin-bottom: 3px" class="" for="customCheck1">Ya</label><br>
										<?php endforeach; ?>
									</div>
								...
								<td>
                                 ...
                                 ";
										...
										<?php foreach ($subMenu as $sm) :
											...
											<?php } else { ?>
												<input class="form-check-input delete-access" type="checkbox" <?= check_access_delete($role['level_id'], $sm['sub_menu_id']); ?> data-level="<?= $role['level_id']; ?>" data-submenu="<?= $sm['sub_menu_id'] ?>">
											<?php } ?>
											<label style="margin-bottom: 3px" class="" for="customCheck1">Ya</label><br>
										<?php endforeach; ?>
									</div>
