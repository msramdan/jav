					...
					<?php foreach ($team_data as $team) { ?>
						<div class="col-lg-3 col-md-6 col-sm-12">
							<div class="team-member">
								<a title="<?= $team->name ?>" href="<?= base_url() ?>assets/web/img/team/<?= $team->photo ?>" data-gal="magnific-pop-up[team]" class="team-member-img-wrap"><img src="<?= base_url() ?>assets/web/img/team/<?= $team->photo ?>" alt="<?= $team->name ?>"></a>
								<div class="team-member-caption social-icons">
									<button style="margin-top: 3px;" id="view_bio" type="button" class="btn btn-outline-success" data-toggle="modal" data-bio="<?= $team->biografi ?>" data-target="#exampleModal">
										<?= $team->name ?>
									</button>
									<button style="margin-top: 3px;margin-bottom:2px" type="button" class="btn btn-outline-success">
									<?= $team->position ?>
									</button>
								</div>
							</div>
			...
			<div class="section-overlay">
				<div class="container">
					<div class="text-center top-text">
						...
						<h4><?= strtoupper($sett_apps->nama_perusahaan) ?></h4>
					</div>
					<div class="video-content">
						<p class="text-center">We’re an International Surveyor Adjuster the solution to your problems</p>
						<div class="magnific-popup-gallery">
							<div class="btn-wrapper text-center"><a class="image-wrap mfp-youtube" href="<?= $video_promo->link ?>"></a></div>
						</div>
					</div>
				</div>
			</div>
