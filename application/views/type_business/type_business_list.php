<div id="content" class="app-content">
	<h1 class="page-header">DATA TYPE_BUSINESS</h1>
							...
							<div class='row'>
								<div class='col-md-9'>
									<div style="padding-bottom: 10px;">
										<?php echo anchor(site_url('type_business/create'), '<i class="fas fa-plus-square" aria-hidden="true"></i> Tambah Data', 'class="btn btn-danger btn-sm tambah_data"'); ?>
									</div>
								</div>
							</div>
							<div class="box-body" style="overflow-x: scroll; ">
								<table id="data-table-default" class="table table-bordered table-hover table-td-valign-middle text-white">
									...
									<tr class="table-secondary">
											...
											<th>Type Business Code</th>
											<th>Type Business Name</th>
											<th>Action</th>
										</tr>
									</thead>
									<tbody><?php $no = 1;
											foreach ($type_business_data as $type_business) {
											?>
											<tr>
												<td><?= $no++ ?></td>
												<td><?php echo $type_business->type_business_code ?></td>
