<div id="content" class="app-content">
	<h1 class="page-header"> DATA ADJUSTER</h1>
						...
						<div class="box-body">
							<div class='row'>
								<div class='col-md-9'>
									<div style="padding-bottom: 10px;">
										<?php echo anchor(site_url('adjuster/create'), '<i class="fas fa-plus-square" aria-hidden="true"></i> Tambah Data', 'class="btn btn-danger btn-sm tambah_data"'); ?>
									</div>
								</div>
							</div>
							<div class="box-body" style="overflow-x: scroll; ">
								<table id="data-table-default" class="table table-bordered table-hover table-td-valign-middle text-white">
									...
									<tbody><?php $no = 1;
											foreach ($adjuster_data as $adjuster) {
											?>
											<tr>
												<td><?= $no++ ?></td>
												<td><?php echo $adjuster->adjuster_code ?></td>
