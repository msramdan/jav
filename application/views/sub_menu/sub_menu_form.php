			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post">
					<table id="" class="table  table-bordered table-hover table-td-valign-middle">
						...
						<tr>
							<td >Nama Sub Menu <?php echo form_error('nama_sub_menu') ?></td>
							<td><input type="text" class="form-control" name="nama_sub_menu" id="nama_sub_menu" placeholder="Nama Sub Menu" value="<?php echo $nama_sub_menu; ?>" /></td>
						</tr>
						<tr>
						...
						<tr>
							<td></td>
							<td><input type="hidden" name="sub_menu_id" value="<?php echo $sub_menu_id; ?>" />
