<div id="content" class="app-content">
            <h1 class="page-header">DATA SECRETARY</h1>  
        ...
        <?php echo anchor(site_url('secretary/create'), '<i class="fas fa-plus-square" aria-hidden="true"></i> Tambah Data', 'class="btn btn-danger btn-sm tambah_data"'); ?>
                </div>
            </div>
        </div>    
		...
		<th>Action</th>
            ...
            foreach ($secretary_data as $secretary)
            {
                ?>
                <tr>
			<td><?= $no++?></td>
			<td><?php echo $secretary->secretary_code ?></td>
			<td><?php echo $secretary->secretary_name ?></td>
