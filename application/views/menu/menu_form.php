			...
			<div class="panel-body">
				...
				<form action="<?php echo $action; ?>" method="post">
					<table id="" class="table  table-bordered table-hover table-td-valign-middle">
						<tr>
							<td >Menu <?php echo form_error('menu') ?></td>
							<td><input type="text" class="form-control" name="menu" id="menu" placeholder="Menu" value="<?php echo $menu; ?>" /></td>
						</tr>
						<tr>
						...
						<tr>
							<td >Urutan <?php echo form_error('urutan') ?></td>
							<td><input type="text" class="form-control" name="urutan" id="urutan" placeholder="Urutan" value="<?php echo $urutan; ?>" /></td>
						</tr>
						<tr>
							<td></td>
