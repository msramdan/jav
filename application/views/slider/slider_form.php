	...
	<div class="col-md-6 ui-sortable">
		<div class="panel panel-inverse" data-sortable-id="form-stuff-1" style="" data-init="true">
			...
			<div class="panel-heading ui-sortable-handle">
				<h4 class="panel-title">KELOLA DATA SLIDER</h4>
				...
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
					<thead>
						<table id="data-table-default" class="table  table-bordered table-hover table-td-valign-middle">
							...
							<tr>
								<td>Span Title <?php echo form_error('span_title') ?></td>
								<td><input type="text" class="form-control" name="span_title" id="span_title" placeholder="Span Title" value="<?php echo $span_title; ?>" /></td>
							</tr>
							...
							<?php } else { ?>
								<div class="form-group">
									<tr>
										<td>Photo <?php echo form_error('photo') ?></td>
										<td>
											<a href="#modal-dialog" data-bs-toggle="modal"><img src="<?php echo base_url(); ?>assets/web/img/slider/<?= $photo ?>" style="width: 150px;height: 150px;border-radius: 5%;"></img></a>
							...
							<tr>
								<td></td>
								<td><input type="hidden" name="slider_id" value="<?php echo $slider_id; ?>" />
									<button type="submit" class="btn btn-danger"><i class="fas fa-save"></i> <?php echo $button ?></button>
									<a href="<?php echo site_url('slider') ?>" class="btn btn-info"><i class="fas fa-undo"></i> Back</a>
								</td>
							</tr>
					</thead>
					</table>
